...
# Generated by qmake (2.01a) (Qt 4.8.6) on: ?? 2. ??? 15:41:24 2015
# Project:  WealthCoin-qt.pro
# Template: app
# Command: c:\Qt\4.8.6\bin\qmake.exe USE_UPNP=- -o Makefile WealthCoin-qt.pro
#############################################################################
...
Makefile: WealthCoin-qt.pro  ../../Qt/4.8.6/mkspecs/win32-g++-4.6/qmake.conf ../../Qt/4.8.6/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_UPNP=- -o Makefile WealthCoin-qt.pro
...
clean: release-clean debug-clean FORCE
	-$(DEL_FILE) C:/deps/WealthCoin-master/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) C:/deps/WealthCoin-master/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) $(MAKE)
	-$(DEL_FILE) clean
...
C:/deps/WealthCoin-master/src/leveldb/libleveldb.a: FORCE
	cd C:/deps/WealthCoin-master/src/leveldb && CC=gcc CXX=g++ TARGET_OS=OS_WINDOWS_CROSSCOMPILE $(MAKE) OPT="-pipe -fno-keep-inline-dllexport -O2" libleveldb.a libmemenv.a && ranlib C:/deps/WealthCoin-master/src/leveldb/libleveldb.a && ranlib C:/deps/WealthCoin-master/src/leveldb/libmemenv.a
