...
#endif
static const uint256 hashGenesisBlock("000000ea03799dc12fc07c4746d6b67d4ae9352c8889a4460e73a1db03415fa3");
static const uint256 hashGenesisBlockTestNet("000000ea03799dc12fc07c4746d6b67d4ae9352c8889a4460e73a1db03415fa3");

inline int64_t PastDrift(int64_t nTime)   { return nTime - 10 * 60; } // up to 5 minutes from the past   - down from 10 for security
inline int64_t FutureDrift(int64_t nTime) { return nTime + 10 * 60; } // up to 5 minutes from the future
